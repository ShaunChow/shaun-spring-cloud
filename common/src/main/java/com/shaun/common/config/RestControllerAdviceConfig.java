...
@ConditionalOnExpression("'${setting.shaun-rest-controller-advice.enable}'.equals('true')")
@Configuration
public class RestControllerAdviceConfig {
    ...
    public class ShaunRestControllerAdvice implements ResponseBodyAdvice<Object> {
        ...
        private final Logger log = LoggerFactory.getLogger(RestControllerAdviceConfig.ShaunRestControllerAdvice.class);
